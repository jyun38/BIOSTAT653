ods pdf file = "K:\BIOS 653\project\Output_model2.pdf";
/*this version has these variables in the model:  Sex Group*days Fatmass_cent Adiponectin_cent MuscleGlycogen_cent*/;
data exercise;
...
class ID Group Sex;
model GIRperkgFFMperinsulin =  Sex Group*days Fatmass_cent Adiponectin_cent MuscleGlycogen_cent/noint solution;
